...
To install the project, run : `npm install`. You need to have npm and node installed globally first.

To start the project, run : `npm start`. The application will run on localhost:3000.
